    ...
    return (
        <section id="home" className="min-h-[85vh] flex items-center justify-center text-center pt-20">
            <div className="container px-6" data-aos="fade-up">
                <h1 className="text-4xl md:text-3xl font-extrabold text-foreground mb-6 leading-tight tracking-tight">
                    Salut, je suis <br /><span className="text-primary">GBASSI Jules-Christ</span>
                </h1>
                <p className="text-lg md:text-5xl text-muted-foreground mb-10 max-w-2xl mx-auto leading-relaxed" data-aos="fade-up" data-aos-delay="100">
